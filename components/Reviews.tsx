...
function Testimonial({ testimonial, index, total, onNext, onPrev }: any) {
    ...
    return (
        <div>
           <motion.div ref={ref} variants={sectionVariants} initial="hidden" animate={inView ? "show" : "hidden"} className="lg:mx-20 mx-5 py-20 bg-[#eff4e2] shadow-md rounded-md">
                <AnimatePresence mode="wait">
                    <div  className="flex items-start lg:items-center justify-between gap-3 px-10 lg:justify-end lg:pr-16">
                        ...
                        <div className="flex gap-4">
                            <button onClick={onPrev || handlePrev}>
                                <Image src={right} alt="left" className="rotate-180" />
                            </button>
                            <button onClick={onNext || handleNext}>
